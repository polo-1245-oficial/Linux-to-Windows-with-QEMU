...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://software-download.microsoft.com/download/sg/20348.169.210806-2348.fe_release_svc_refresh_SERVER_EVAL_x64FRE_es-es.iso
